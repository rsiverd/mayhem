...
fdate_list=()
for (( n = -$days_after; n <= $days_before; n++ )); do
...
nite_bias="$nite_folder/med_bias_${fdate}_1day.fits"
nite_dark="$nite_folder/med_dark_${fdate}_1day.fits"
...
######################################################################
# CHANGELOG (01_create_master_bias_dark.sh):
#---------------------------------------------------------------------
#
#  2017-07-12:
